...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'Olá! Bem-vindo a Cake Walk. Quando é seu aniversário?';
        const repromptText = 'Eu nasci dia 6 de novembro de dois mil e quatorze. Quando você nasceu?';
...
const HasBirthdayLaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (currentDate.getTime() !== nextBirthday) {
            ...
            speakOutput = `Bem vindo de volta. Parece que falta ${diffDays} dias até seu ${currentYear - year} aniversário.`
        }
...
const CaptureBirthdayIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speechText = `Obrigada, vou lembrar que seu aniversário é dia ${day} de ${month} de ${year}.`;
        return handlerInput.responseBuilder
            .speak(speechText)
            .getResponse();
    }
